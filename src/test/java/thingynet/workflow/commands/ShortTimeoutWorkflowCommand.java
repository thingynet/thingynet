/*
 * ShortTimeoutWorkflowCommand.java
 *
...
@Component
public class ShortTimeoutWorkflowCommand implements WorkflowCommand {
    private static final Logger log = Logger.getLogger(ShortTimeoutWorkflowCommand.class.getName());

    @Override
    public void execute(Workflow workflow) throws WorkflowException {
        log.debug("Short timeout command executed");
    }
