...
public class IntegerValueTest {
    private static final IntegerValue SAVE_VALUE = new IntegerValue(1);
    private static final IntegerValue UPDATE_VALUE = new IntegerValue(2);
    ...
    public void saveShouldSaveExpectedValues() {
        ...
        IntegerValue value = (IntegerValue) actual.getValue();
