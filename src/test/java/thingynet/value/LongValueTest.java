...
public class LongValueTest {
    private static final LongValue SAVE_VALUE = new LongValue(1l);
    private static final LongValue UPDATE_VALUE = new LongValue(2l);
    ...
    public void saveShouldSaveExpectedValues() {
        ...
        LongValue value = (LongValue) actual.getValue();
