...
public class ObjectIdValueTest {
    private static final ObjectIdValue SAVE_VALUE = new ObjectIdValue(new ObjectId());
    private static final ObjectIdValue UPDATE_VALUE = new ObjectIdValue(new ObjectId());
    ...
    public void saveShouldSaveExpectedValues() {
        ...
        ObjectIdValue value = (ObjectIdValue) actual.getValue();
